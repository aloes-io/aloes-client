<template lang="html">
  <div class="login-alert-view">
    ...
    <b-alert v-if="forgotPasswordError" :show="forgotPasswordError !== null" variant="warning">
      {{ forgotPasswordError.message }}
      <b-button v-if="forgotPasswordError.code" :to="{ name: 'home' }" class="btn btn-warning">
        <small>
          Signup
        </small>
      </b-button>
      <b-button v-if="!forgotPasswordError.code" class="btn btn-warning" @click="onVerify">
        <small>
          Verify email address
        </small>
      </b-button>
    </b-alert>
    <b-alert v-if="forgotPasswordSuccess" :show="forgotPasswordSuccess !== null" variant="success">
