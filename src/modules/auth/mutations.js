...
export function cleanForgotPassword(state) {
  ...
  logger.publish(
    4,
    state.collectionName,
    "commit:cleanForgotPassword:res",
    state.forgotPassword
  );
}
